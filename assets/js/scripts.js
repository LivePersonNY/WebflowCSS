...
!function(t,e,n,o){var i="virtualMouseBindings",a="virtualTouchID",r="vmouseover vmousedown vmousemove vmouseup vclick vmouseout vmousecancel".split(" "),s="clientX clientY pageX pageY screenX screenY".split(" "),c=t.event.mouseHooks?t.event.mouseHooks.props:[],u=t.event.props.concat(c),h={},l=0,d=0,v=0,p=!1,f=[],g=!1,m=!1,b="addEventListener"in n,w=t(n),T=1,D=0;function E(t){for(;t&&void 0!==t.originalEvent;)t=t.originalEvent;return t}function k(e){for(var n,o,a={};e;){for(o in n=t.data(e,i))n[o]&&(a[o]=a.hasVirtualBinding=!0);e=e.parentNode}return a}function y(){m=!0}function X(){m=!1}function Y(){M(),l=setTimeout(function(){l=0,D=0,f.length=0,g=!1,y()},t.vmouse.resetTimerDuration)}function M(){l&&(clearTimeout(l),l=0)}function P(e,n,a){var r;return(a&&a[e]||!a&&function(e,n){for(var o;e;){if((o=t.data(e,i))&&(!n||o[n]))return e;e=e.parentNode}return null}(n.target,e))&&(r=function(e,n){var i,a,r,c,h,l,d,v,p=e.type;if((e=t.Event(e)).type=n,i=e.originalEvent,a=t.event.props,p.search(/^(mouse|click)/)>-1&&(a=u),i)for(d=a.length;d;)e[c=a[--d]]=i[c];if(p.search(/mouse(down|up)|click/)>-1&&!e.which&&(e.which=1),-1!==p.search(/^touch/)&&(p=(r=E(i)).touches,h=r.changedTouches,l=p&&p.length?p[0]:h&&h.length?h[0]:o))for(v=0,len=s.length;v<len;v++)e[c=s[v]]=l[c];return e}(n,e),t(n.target).trigger(r)),r}function I(e){var n=t.data(e.target,a);if(!(g||D&&D===n)){var o=P("v"+e.type,e);o&&(o.isDefaultPrevented()&&e.preventDefault(),o.isPropagationStopped()&&e.stopPropagation(),o.isImmediatePropagationStopped()&&e.stopImmediatePropagation())}}function S(e){var n,o,i=E(e).touches;if(i&&1===i.length&&(o=k(n=e.target)).hasVirtualBinding){D=T++,t.data(n,a,D),M(),X(),p=!1;var r=E(e).touches[0];d=r.pageX,v=r.pageY,P("vmouseover",e,o),P("vmousedown",e,o)}}function B(t){m||(p||P("vmousecancel",t,k(t.target)),p=!0,Y())}function N(e){if(!m){var n=E(e).touches[0],o=p,i=t.vmouse.moveDistanceThreshold;p=p||Math.abs(n.pageX-d)>i||Math.abs(n.pageY-v)>i,flags=k(e.target),p&&!o&&P("vmousecancel",e,flags),P("vmousemove",e,flags),Y()}}function j(t){if(!m){y();var e,n=k(t.target);if(P("vmouseup",t,n),!p){var o=P("vclick",t,n);o&&o.isDefaultPrevented()&&(e=E(t).changedTouches[0],f.push({touchID:D,x:e.clientX,y:e.clientY}),g=!0)}P("vmouseout",t,n),p=!1,Y()}}function x(e){var n,o=t.data(e,i);if(o)for(n in o)if(o[n])return!0;return!1}function z(){}function H(e){var n=e.substr(1);return{setup:function(o,a){x(this)||t.data(this,i,{}),t.data(this,i)[e]=!0,h[e]=(h[e]||0)+1,1===h[e]&&w.bind(n,I),t(this).bind(n,z),b&&(h.touchstart=(h.touchstart||0)+1,1===h.touchstart&&w.bind("touchstart",S).bind("touchend",j).bind("touchmove",N).bind("scroll",B))},teardown:function(o,a){--h[e],h[e]||w.unbind(n,I),b&&(--h.touchstart,h.touchstart||w.unbind("touchstart",S).unbind("touchmove",N).unbind("touchend",j).unbind("scroll",B));var r=t(this),s=t.data(this,i);s&&(s[e]=!1),r.unbind(n,z),x(this)||r.removeData(i)}}}t.vmouse={moveDistanceThreshold:10,clickDistanceThreshold:10,resetTimerDuration:1500};for(var L=0;L<r.length;L++)t.event.special[r[L]]=H(r[L]);b&&n.addEventListener("click",function(e){var n,o,i,r,s,c=f.length,u=e.target;if(c)for(n=e.clientX,o=e.clientY,threshold=t.vmouse.clickDistanceThreshold,i=u;i;){for(r=0;r<c;r++)if(s=f[r],0,i===u&&Math.abs(s.x-n)<threshold&&Math.abs(s.y-o)<threshold||t.data(i,a)===s.touchID)return e.preventDefault(),void e.stopPropagation();i=i.parentNode}},!0)}(jQuery,window,document),function(t,e,n){function o(e,n,o){var i=o.type;o.type=n,t.event.handle.call(e,o),o.type=i}t.each("touchstart touchmove touchend tap taphold swipe swipeleft swiperight".split(" "),function(e,n){t.fn[n]=function(t){return t?this.bind(n,t):this.trigger(n)},t.attrFn[n]=!0}),t.event.special.tap={setup:function(){var e=this,n=t(e);n.bind("touchstart",function(i){if(i.which&&1!==i.which)return!1;var a,r=i.target;i.originalEvent;function s(){clearTimeout(a)}function c(){s(),n.unbind("vclick",u).unbind("vmouseup",s),t(document).unbind("vmousecancel",c)}function u(t){c(),r==t.target&&o(e,"tap",t)}n.bind("vmouseup",s).bind("vclick",u),t(document).bind("vmousecancel",c),a=setTimeout(function(){o(e,"taphold",t.Event("taphold",{target:r}))},750)})}},t.event.special.swipe={scrollSupressionThreshold:10,durationThreshold:1e3,horizontalDistanceThreshold:30,verticalDistanceThreshold:75,setup:function(){var e=t(this);e.bind("touchstart",function(n){var o,i=n.originalEvent.touches?n.originalEvent.touches[0]:n,a={time:(new Date).getTime(),coords:[i.pageX,i.pageY],origin:t(n.target)};function r(e){if(a){var n=e.originalEvent.touches?e.originalEvent.touches[0]:e;o={time:(new Date).getTime(),coords:[n.pageX,n.pageY]},Math.abs(a.coords[0]-o.coords[0])>t.event.special.swipe.scrollSupressionThreshold&&e.preventDefault()}}e.bind("touchmove",r).one("touchend",function(n){e.unbind("touchmove",r),a&&o&&o.time-a.time<t.event.special.swipe.durationThreshold&&Math.abs(a.coords[0]-o.coords[0])>t.event.special.swipe.horizontalDistanceThreshold&&Math.abs(a.coords[1]-o.coords[1])<t.event.special.swipe.verticalDistanceThreshold&&a.origin.trigger("swipe").trigger(a.coords[0]>o.coords[0]?"swipeleft":"swiperight"),a=o=void 0})})}},t.each({taphold:"tap",swipeleft:"swipe",swiperight:"swipe"},function(e,n){t.event.special[e]={setup:function(){t(this).bind(n,t.noop)}}})}(jQuery);
